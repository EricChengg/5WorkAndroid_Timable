...
CREATE TABLE IF NOT EXISTS `mydb`.`Class` (
  ...
  INDEX `fk_Course_Subject1_idx` (`Subject_subjectID` ASC),
...
-- -----------------------------------------------------
-- Table `mydb`.`Campus_has_Class`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Campus_has_Class` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Campus_has_Class` (
  `Campus_CampusID` INT NOT NULL,
  `Class_courseID` INT NOT NULL,
  `Class_Subject_subjectID` INT NOT NULL,
  PRIMARY KEY (`Campus_CampusID`, `Class_courseID`, `Class_Subject_subjectID`),
  INDEX `fk_Campus_has_Class_Class1_idx` (`Class_courseID` ASC, `Class_Subject_subjectID` ASC),
  INDEX `fk_Campus_has_Class_Campus1_idx` (`Campus_CampusID` ASC),
  CONSTRAINT `fk_Campus_has_Class_Campus1`
    FOREIGN KEY (`Campus_CampusID`)
    REFERENCES `mydb`.`Campus` (`CampusID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Campus_has_Class_Class1`
    FOREIGN KEY (`Class_courseID` , `Class_Subject_subjectID`)
    REFERENCES `mydb`.`Class` (`classID` , `Subject_subjectID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Class_has_Student` (
  ...
  PRIMARY KEY (`Class_courseID`, `Class_Subject_subjectID`, `Student_studentID`),
  INDEX `fk_Class_has_Student_Student1_idx` (`Student_studentID` ASC),
  INDEX `fk_Class_has_Student_Class1_idx` (`Class_courseID` ASC, `Class_Subject_subjectID` ASC),
